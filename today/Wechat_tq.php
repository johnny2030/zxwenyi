    ...
    public function responseMsg(){
        ...
        if(strtolower($postObj->MsgType) == 'event'){
            ...
            if(strtolower($postObj->Event) == 'subscribe'){
                $news_arr = array(
                    'news1' => array('title' => '欢迎关注铁樵健康', 'decription' => '用我们贴心的服务，换您满意的微笑！', 'PicUrl' => 'http://tieqiao.zzzpsj.com/themes/dp/Public/images/welcome.jpg', 'Url' => 'http://tieqiao.zzzpsj.com/index.php?g=portal&m=user&a=user_info'),
                ...
                $info = sprintf($template, $toUser, $fromUser, $time, $news_arr['news1']['title'], $news_arr['news1']['decription'], $news_arr['news1']['PicUrl'], $news_arr['news1']['Url'], $news_arr['news3']['title'], $news_arr['news3']['decription'], $news_arr['news3']['PicUrl'], $news_arr['news3']['Url'], $news_arr['news7']['title'], $news_arr['news7']['decription'], $news_arr['news7']['PicUrl'], $news_arr['news7']['Url'], $news_arr['news8']['title'], $news_arr['news8']['decription'], $news_arr['news8']['PicUrl'], $news_arr['news8']['Url']);
                echo $info;
            }
            //用户已关注时
            ...
            if(strtolower($postObj->Event) == 'click'){
                ...
                switch($EventKey){
                    case "newOne":
                        $news_arr = array(
                            'news1' => array('title' => '关于健康饮食', 'decription' => '关于健康饮食', 'PicUrl' => 'http://tieqiao.zzzpsj.com/upload_img/push/11.png', 'Url' => 'https://mp.weixin.qq.com/s/MdhCNQp3dhNjo3Nzjf7ywQ'),
                            'news2' => array('title' => '世卫组织：身体活动指南', 'decription' => '世卫组织：身体活动指南', 'PicUrl' => 'http://tieqiao.zzzpsj.com/upload_img/push/10.png', 'Url' => 'https://mp.weixin.qq.com/s/4liyy0YN1QQlW-WXgKho_g'),
                            'news3' => array('title' => '医生及患者通用：如何用手机翻拍X线片，磁共振片子，CT片子进行网络求医、病例讨论及保留资料', 'decription' => '医生及患者通用：如何用手机翻拍X线片，磁共振片子，CT片子进行网络求医、病例讨论及保留资料', 'PicUrl' => 'http://tieqiao.zzzpsj.com/upload_img/push/9.png', 'Url' => 'https://mp.weixin.qq.com/s/RIYsdMUvqmK0DAgQKzu_2A'),
                            'news4' => array('title' => '为什么医生让我做了CT，又要做核磁共振？', 'decription' => '为什么医生让我做了CT，又要做核磁共振？', 'PicUrl' => 'http://tieqiao.zzzpsj.com/upload_img/push/1.jpg', 'Url' => 'https://mp.weixin.qq.com/s?__biz=MzU1MjcxNzk2Mg==&mid=2247483726&idx=1&sn=b90ea22b52187a9b7ee351505b682f6e&chksm=fbfc9aabcc8b13bd451a27767269e81575e6ad75154acb26bd0b9776f6e7835bf0f81700f983&token=355504380&lang=zh_CN#rd'),
                            'news5' => array('title' => '[传承创新一体 协作融合共赢］第十届江浙沪中西医结合高峰论坛2018年江浙沪中西医结合肿瘤学术年会圆满胜利召开', 'decription' => '[传承创新一体 协作融合共赢］第十届江浙沪中西医结合高峰论坛2018年江浙沪中西医结合肿瘤学术年会圆满胜利召开', 'PicUrl' => 'http://tieqiao.zzzpsj.com/upload_img/push/2.jpg', 'Url' => 'https://mp.weixin.qq.com/s/Ya2Yc-bXiCHJwEZE-WVBxQ'),
                            'news6' => array('title' => '史上最全体检报告漫画解读！速速收藏！', 'decription' => '史上最全体检报告漫画解读！速速收藏！', 'PicUrl' => 'http://tieqiao.zzzpsj.com/upload_img/push/3.jpg', 'Url' => 'https://mp.weixin.qq.com/s?__biz=MzU1MjcxNzk2Mg==&mid=2247483726&idx=3&sn=ddb2c7614c6e17a6b3de381dd59d51b8&chksm=fbfc9aabcc8b13bd730c96cd0e3fc1458f9d8fcf48993461ccabeb9230b1a41694edd090111a&token=355504380&lang=zh_CN#rd'),
                            'news7' => array('title' => 'CSPE 2018｜心律失常诊治讲座荟萃（一）', 'decription' => 'CSPE 2018｜心律失常诊治讲座荟萃（一）', 'PicUrl' => 'http://tieqiao.zzzpsj.com/upload_img/push/4.jpg', 'Url' => 'https://mp.weixin.qq.com/s/AyVSP0QabkINsPaGm0kL4A'),
                            'news8' => array('title' => '尿酸偏高但没有痛风表现，要紧吗？除了痛风，高尿酸血症还有更多危害！', 'decription' => '尿酸偏高但没有痛风表现，要紧吗？除了痛风，高尿酸血症还有更多危害！', 'PicUrl' => 'http://tieqiao.zzzpsj.com/upload_img/push/5.jpg', 'Url' => 'https://mp.weixin.qq.com/s/EWHMSNZdtVU4wk6OsIznlg')
                        );
                        $time = time();
                        $count = 8;
                        break;
